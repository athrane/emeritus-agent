...
To instal the bundle build into the `Cables.gl` patch, follow these steps:
...
* Locate and open the RungAgent2 operator.
* Locate the LIBS section of the configuration, delete reference to the used bundle.js file.
* Select the Patch Files menu.
* Delete the current bundle.js file.
